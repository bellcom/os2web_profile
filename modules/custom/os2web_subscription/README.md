...
Description
-----------
Makes it possible to subscribe to a certain event on the site with an email.
This is not dependent to any user in drupal and are only registrating the users
email. User can go to SITE_URL/your-subscriptions to enable recieving emails
from any categories. The module also provides a block to be shown on. This block
only adds the email to that specific content type.
